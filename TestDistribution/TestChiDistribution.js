...
(function() {
 function define() {
  var chi = {
   name: 'distribution.chiDistribution',
   body: [],
  ...
  try {
   ...
   var pdf1 = ak.chiPDF(1);
   var pdf2 = ak.chiPDF(2);
   var pdf9 = ak.chiPDF(9);
  
   var cdf1 = ak.chiCDF(1);
   var cdf2 = ak.chiCDF(2);
   var cdf9 = ak.chiCDF(9);
  
   var inv_cdf1 = ak.chiInvCDF(1);
   var inv_cdf2 = ak.chiInvCDF(2);
   var inv_cdf9 = ak.chiInvCDF(9);
  
   var cf1 = ak.chiCF(1);
   var cf2 = ak.chiCF(2);
   var cf9 = ak.chiCF(9);
  
   var rnd01 = ak.chiRnd(1);
   var rnd02 = ak.chiRnd(2);
   var rnd09 = ak.chiRnd(9);
   var rnd11 = ak.chiRnd(1, rnd);
   var rnd12 = ak.chiRnd(2, rnd);
   var rnd19 = ak.chiRnd(9, rnd);
   ...
   function bad() {
    try {ak.chiPDF(0); return false;} catch(e) {}
    try {ak.chiPDF(2.5); return false;} catch(e) {}
    try {ak.chiCDF(0); return false;} catch(e) {}
    try {ak.chiCDF(2.5); return false;} catch(e) {}
    try {ak.chiInvCDF(0); return false;} catch(e) {}
    try {ak.chiInvCDF(2.5); return false;} catch(e) {}
    try {ak.chiCF(0); return false;} catch(e) {}
    try {ak.chiCF(2.5); return false;} catch(e) {}
    try {ak.chiRnd(0); return false;} catch(e) {}
    try {ak.chiRnd(2.5); return false;} catch(e) {}
    return true;
   }
   ...
   function testPDF(pdf) {
    ...
    for(x=0.1;x<=4;x+=0.1) {
     x2 = x*x;
     y = (k/2 - 1)*Math.log(x2) - x2/2 - Math.log(2)*k/2 - ak.logGamma(k/2);
     if(!(ak.dist(pdf(x), 2*x*Math.exp(y))<d)) return false;
    }
    return true;
   }
 ...
 ak.using('Distribution/ChiDistribution.js', define);
})();