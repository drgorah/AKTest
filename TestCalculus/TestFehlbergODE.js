...
(function() {
 function define() {
  ...
  try {
   ...
   evaluate.add('heun rkf2 first order', function() {return firstOrder(ak.heunRKF2ODE, 2);});
   evaluate.add('heun rkf2 second order', function() {return secondOrder(ak.heunRKF2ODE, 2);});
   evaluate.add('bogacki-shampine rkf3 first order', function() {return firstOrder(ak.bogackiShampineRKF3ODE, 3);});
   evaluate.add('bogacki-shampine rkf3 second order', function() {return secondOrder(ak.bogackiShampineRKF3ODE, 3);});
   evaluate.add('fehlberg rkf5 first order', function() {return firstOrder(ak.fehlbergRKF5ODE, 5);});
   evaluate.add('fehlberg rkf5 second order', function() {return secondOrder(ak.fehlbergRKF5ODE, 5);});
   evaluate.add('cash-karp rkf5 first order', function() {return firstOrder(ak.cashKarpRKF5ODE, 5);});
   evaluate.add('cash-karp rkf5 second order', function() {return secondOrder(ak.cashKarpRKF5ODE, 5);});
   evaluate.add('dormand-prince rkf5 first order', function() {return firstOrder(ak.dormandPrinceRKF5ODE, 5);});
   evaluate.add('dormand-prince rkf5 second order', function() {return secondOrder(ak.dormandPrinceRKF5ODE, 5);});
