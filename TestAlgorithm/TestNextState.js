...
(function() {
 function define() {
  ...
  try {
   ...
   apply.add('array-array', function(){return cycle([1, 2, 3], [1, 2, 3], [4, 5, 6]);});
   apply.add('array-number', function(){return cycle([1, 2, 3], [1, 2, 3], 6);});
   apply.add('array-undefined', function(){return cycle([1, 2, 3], [4, 5, 6]);});
   apply.add('number-array', function(){return cycle([1, 2, 3], 1, [4, 5, 6]);});
   apply.add('number-number', function(){return cycle([1, 2, 3], 1, 6);});
   apply.add('number-undefined', function(){return cycle([1, 2, 3], 6);});
  ...
  akTest.add(nextState);
 }

 ak.using('Algorithm/NextState.js', define);
})();